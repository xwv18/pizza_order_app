            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="ms-3">
                            <small><i class="fa-regular fa-eye me-2"></i>{{$pizza->view_count + 1}} views</small>
                        </div>
...
@section('scriptSource')
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                        type: 'get',
                        url: '/pizza_hunt/public/user/ajax/view/count',
            ...
            $('#addCart').click(function() {
                ...
                $.ajax({
                        type: 'get',
                        url: '/pizza_hunt/public/user/ajax/addToCart',
                        data: $source,
                        dataType: 'json',
